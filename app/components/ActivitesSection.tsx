...
const activities = [
  {
    ...
    description:
      "Conception de plateformes applicatives et développement de solutions web et mobiles adaptées au marché. Nous transformons le potentiel de la jeunesse malgache en compétences techniques pointues pour accompagner la transition numérique des entreprises locales et internationales.",
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "Valorisation des ressources naturelles et du secteur agricole à Madagascar à travers des pratiques durables et respectueuses de l'environnement. Ce pôle crée des chaînes de valeur courtes pour assurer des revenus équitables aux producteurs tout en proposant des produits de qualité.",
    icon: (
      <svg
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5V3.545M12.75 21h7.5V10.75M2.25 21h1.5m18 0h-18M2.25 9l4.5-1.636M18.75 3l-1.5.545m0 0-10.5 3.818m10.5-3.818V21M6.75 7.364V21"
        />
      </svg>
    ),
  ...
  },
  {
    ...
    description:
      "Services d'audit, de conseil stratégique pour les organisations et programmes de formations certifiantes sur-mesure. En synergie directe avec nos branches associatives, ce pôle prépare activement les talents aux exigences réelles des recruteurs pour briser le chômage.",
    icon: (
      <svg
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M4.263 15.918a9 9 0 1 0 15.474 0M12 3v13.5M12 3L7.5 7.5M12 3l4.5 4.5M19.5 12h-15"
        />
      </svg>
    ),
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-3 mb-16">
          ...
          <p className="text-base text-slate-600 font-light max-w-xl mx-auto pt-1 ">
            Des pôles complémentaires créés pour générer des emplois stables,
            valoriser le savoir-faire malgache et financer notre modèle social.
          </p>
        </div>
            ...
            >
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <span
                    className={`inline-block text-xs font-bold px-2.5 py-0.5 rounded-full border ${activity.badgeColor}`}
                  >
                    {activity.subtitle}
                  </span>
