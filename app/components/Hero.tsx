...
export default function Hero() {
    return (
        <section className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-950">
            ...
            {/* 1. Image d'arrière-plan ultra-optimisée (inchangée) */}
            ...
            {/* 2. Contenu textuel avec animations */}
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 w-full">
                <div className="max-w-3xl space-y-6 md:space-y-8 text-left">

                    {/* Badge - Pas d'animation Framer Motion nécessaire ici, la classe CSS 'animate-pulse' suffit */}
                    ...
                    {/* Titre principal - Animé avec FadeIn */}
                    <FadeIn>
                    ...
                    {/* Description - Animée avec FadeIn et un délai (cascade) */}
                    <FadeIn delay={0.2}>
                    ...
                    {/* Boutons d'actions - Animés avec FadeIn et un délai plus long */}
                    <FadeIn delay={0.4}>
            ...
            {/* Indication visuelle de scroll (inchangée) */}
